...
void parse_file ( char * filename, 
  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
    ...
    if ( strncmp( line, "push", strlen(line)) == 0 ) {
      ...
      foo = new_matrix(4, 4);
      add_box(foo, xvals[0], yvals[0], zvals[0],
	      xvals[1], yvals[1], zvals[1]);
      matrix_mult(st->data[st->top], foo);
      //print_stack(st);
      draw_polygons(foo, s, c);
      free_matrix(foo);
    }//end of box
      ...
      sscanf(line, "%lf %lf %lf %lf",
	     xvals, yvals, zvals, &r);
      foo = new_matrix(4,4);
      add_sphere( foo, xvals[0], yvals[0], zvals[0], r, step);
      matrix_mult(st->data[st->top], foo);
      draw_polygons(foo, s, c);
      free_matrix(foo);
    }//end of sphere
      ...
      foo = new_matrix(4,4);
      add_torus( foo, xvals[0], yvals[0], zvals[0], r, r1, step);
      matrix_mult(st->data[st->top], foo);
      draw_polygons(foo, s, c);
      free_matrix(foo);
    }//end of torus
      ...
      sscanf(line, "%lf %lf %lf %lf",
	     xvals, yvals, zvals, &r);
      foo = new_matrix(4,4);
      add_circle( foo, xvals[0], yvals[0], zvals[0], r, step);
      matrix_mult(st->data[st->top], foo);
      draw_lines(foo, s, c);
      free_matrix(foo);
    }//end of circle
	...
	type = BEZIER;
      ...
      //printf("%d\n", type);
      foo = new_matrix(4,4);
      add_curve( foo, xvals[0], yvals[0], xvals[1], yvals[1],
      ...
      /*printf("%lf %lf %lf %lf %lf %lf",
	     ...
	     xvals[1], yvals[1], zvals[1]) */
      foo = new_matrix(4,4);
      add_edge(foo, xvals[0], yvals[0], zvals[0],
	       xvals[1], yvals[1], zvals[1]);      
      matrix_mult(st->data[st->top], foo);
      draw_lines(foo, s, c);
      free_matrix(foo);
